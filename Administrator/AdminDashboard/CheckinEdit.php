...
if (isset($_POST['edit'])) {
  ...
  $sql = "select * from `checked_in` where `checked_in`.`RoomId`=$roomid AND `ID`!=$customerId AND 'Status'='check in'";
...
<?php
  ...
  `RoomId` = '$roomid', `RoomType` = '$roomtype', `Check_In_Date` = '$check_in_date', `Status` = '$status' WHERE `checked_in`.`ID` = $customerId";
            ...
            <div class="col-md-6">
              ...
              <select name="roomid" id="roomid">
                ...
                ?>
                    ...
                    <option <?= $customer['RoomId'] == $room['RoomId'] ? "Not Available" : "" ?> value="<?= $room['RoomId'] ?>"> <?= $room['RoomName'] ?></option>
